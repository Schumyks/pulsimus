...
| 4 | **E3 aterrizaje** | — (escena nueva, pre-Mostrador) | Nubes **FLAT** regeneradas, rol único: atravesar la atmósfera |
...
| 6 | **E5 órbitas** | Proceso | **Se transforma** — mitades espejadas cielo/tierra (ya en el guión) |
| 7 | **E6 mission control** | Tablero | **Se reencuadra** — la maquinaria queda; el envoltorio se mete en escena (caos→orden). EKG #3 |
...
| — | Quien-soy (BL-13) | #quien-soy | **Se adapta** al nuevo estilo del sitio; queda más o menos igual. Gate P1 sigue abierto en paralelo |
